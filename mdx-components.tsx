...
export function useMDXComponents(components: MDXComponents): MDXComponents {
  return {
    ...
    Date: ({ publish_date, ...props }) => {
      ...
      return <p className="text-gray-500 text-sm mb-8">{formattedDate}</p>;
    },
    h1: ({ children, ...props }) => (
      <h1
    ...
    h2: ({ children, ...props }) => (
      <h2
        className="text-[18px] md:text-[20px] font-bold mt-[2em] mb-[1em] text-white font-display"
        {...props}
      >
        {children}
      </h2>
    ...
    h3: ({ children, ...props }) => (
      <h3
        className="text-[var(--neon-cyan)] font-semibold mt-[1.6em] mb-[0.6em] text-white font-display"
        {...props}
      >
        {children}
      </h3>
    ...
    p: ({ children, ...props }) => (
      <p
        className="mb-[0.75em] text-white leading-[1.75] font-body"
    ...
    ul: ({ children, ...props }) => (
      <ul
        className="list-disc mt-[1.25em] mb-[1.25em] pl-[1.625em] text-white font-body"
        style={{ fontSize: "13px" }}
        {...props}
      >
        {children}
    ...
    ol: ({ children, ...props }) => (
      <ol
        className="list-decimal mt-[1.25em] mb-[1.25em] pl-[1.625em] text-white font-body"
        style={{ fontSize: "13px" }}
        {...props}
      >
        {children}
    ...
    li: ({ children, ...props }) => (
      <li
        className="pl-[0.375em] text-white"
        style={{ fontSize: "13px" }}
        {...props}
      >
        {children}
    ...
    a: ({ children, href, ...props }) => {
      ...
      return (
        <a
          href={href}
          className={`text-[var(--neon-cyan)] hover:text-[var(--neon-magenta)] underline font-medium hover:neon-cyan-glow transition-all duration-300 ${
    ...
    th: ({ children, ...props }) => (
      <th
        className="border border-[var(--ui-line)] px-[16px] py-[8px] bg-[rgba(10,12,16,0.5)] font-bold text-left text-white"
    ...
    td: ({ children, ...props }) => (
      <td
        className="border border-[var(--ui-line)] px-[16px] py-[8px] text-white"
        style={{ fontSize: "12px" }}
        {...props}
      >
        {children}
